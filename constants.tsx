...
export const EMPLOYEES: Employee[] = [
  { id: 'emp_1', name: 'Alex Doe', email: 'alex@neo.com', role: UserRole.Employee, avatarUrl: 'https://i.pravatar.cc/150?u=emp_1', teamId: 'team_alpha' },
  { id: 'emp_2', name: 'Liam Gallagher', email: 'liam@neo.com', role: UserRole.ScrumMaster, avatarUrl: 'https://i.pravatar.cc/150?u=emp_2', teamId: 'team_alpha' },
  { id: 'emp_3', name: 'Jane Smith', email: 'jane@neo.com', role: UserRole.Employee, avatarUrl: 'https://i.pravatar.cc/150?u=emp_3', teamId: 'team_alpha' },
  { id: 'emp_4', name: 'Chen Wang', email: 'chen@neo.com', role: UserRole.Employee, avatarUrl: 'https://i.pravatar.cc/150?u=emp_4', teamId: 'team_alpha' },
  { id: 'emp_5', name: 'Priya Sharma', email: 'priya@neo.com', role: UserRole.HR, avatarUrl: 'https://i.pravatar.cc/150?u=emp_5', teamId: 'hr_dept' },
  { id: 'emp_6', name: 'Sam Jones', email: 'sam@neo.com', role: UserRole.Admin, avatarUrl: 'https://i.pravatar.cc/150?u=emp_6', teamId: 'admin_dept' },
];
